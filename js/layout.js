document.addEventListener('DOMContentLoaded', () => {
            ...
            <div style="width: 100%; max-width: 520px; margin: 0 auto; padding: 80px 28px; box-sizing: border-box; background-color: #FFF; font-size: 16px; font-weight: 400; line-height: 1.25; color: #000; font-family: 'Roboto', 'Noto Sans KR', '맑은고딕', Malgun Gothic, '돋움', Dotum, Helvetica, 'Apple SD Gothic Neo', Sans-serif;">
                <div style="width: 100%; max-width: 400px; margin: 0 auto;">
                    <div style="display: table; height: 24px; margin: 0 auto;">
                        ...
                        <span style="display: table-cell; font-size: 16px; font-weight: bold; color: #3A3A3A;">폰트 아카이브</div>
                    </div>
    ...
    wrap.innerHTML += `
        <div style="width: 100%; font-size: 16px; font-weight: 400; line-height: 1.25; color: #000; font-family: 'Roboto', 'Noto Sans KR', '맑은고딕', Malgun Gothic, '돋움', Dotum, Helvetica, 'Apple SD Gothic Neo', Sans-serif;">
            <div style="width: 100%; max-width: 520px; background-color: #FFF; margin: 0 auto; padding: 80px 28px; box-sizing: border-box; font-size: 16px; font-weight: 400; line-height: 1.25; color: #000;">
                <div style="width: 100%; max-width: 400px; margin: 0 auto;">
                    <div style="display: table; height: 24px; margin: 0 auto;">
                        <span style="display: table-cell; vertical-align: middle;"><img style="height: 18px; margin-right: 8px;" src="https://fonts-archive.s3.ap-northeast-2.amazonaws.com/logo.png"/></span>
                        <span style="display: table-cell; font-size: 16px; font-weight: bold; color: #3A3A3A;">폰트 아카이브</div>
                    ...
                    <p style="text-align: center; margin: 40px 0;">
                        <img src="https://fonts-archive.s3.ap-northeast-2.amazonaws.com/3d_lock.png" alt="메일 아이콘" style="width: 140px;"/>
                    </p>
                    <p style="width: 100%; font-size: 14px; font-weight: 400; line-height: 2; color: #3A3A3A; margin: 0; margin-top: 48px;">
                        안녕하세요 ${"홍길동"}님, <br/>
                        이제 아래 <span style="font-weight: bold; color: #000;">임시 비밀번호</span>를 통해 로그인 하실 수 있습니다.
                    </p>
                    <div style="width: 100%; padding: 16px 20px; box-sizing: border-box; margin: 20px 0; box-sizing: border-box; background-color: #E9F0FE; font-size: 14px; font-weight: bold; color: #3A3A3A; text-decoration: none; border-radius: 6px;">
                        ${"랜덤 비밀번호"}
                    </div>
                    <p style="width: 100%; font-size: 14px; font-weight: 400; line-height: 2; color: #3A3A3A;">
                        로그인이 되지 않을 경우, <br/>
                        아래 링크에 접속하여 <span style="font-weight: bold; color: #000;">임시 비밀번호</span>를 다시 발급받아 주세요. <br/>
